...
void test_error_string( void )
{
    ...
    TEST_ASSERT_MESSAGE(strcmp(error_string(FILE_CANT_BE_OPENED), FILE_CANT_BE_OPENED_STR) == 0, "FILE_CANT_BE_OPENED error code was not handled correctly!");
    TEST_ASSERT_MESSAGE(strcmp(error_string(FILE_CANT_BE_CLOSED), FILE_CANT_BE_CLOSED_STR) == 0, "FILE_CANT_BE_CLOSED error code was not handled correctly!");
